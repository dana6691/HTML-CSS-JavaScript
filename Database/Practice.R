...
ui <- dashboardPage(
  ...
  dashboardBody(
    box(
      title = "Dataset", status = "primary", solidHeader = TRUE, width = 2,
      "Box content here", br(), "More box content",
      selectInput("TheFile", "Select Dataset", 
                  choices = c("Metadata.csv", "AH_final_Mean.csv"))
    ),
    box(title = "1st Table", status = "primary", solidHeader = TRUE, width = 2,
    ...
    box(title = "2nd Table", status = "primary", solidHeader = TRUE, width = 2,
